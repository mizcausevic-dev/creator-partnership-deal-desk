...
function topbar() {
  return `<div class="topbar"><div class="left">Kinetic Gain · Operator Surface</div><div class="right"><div>Site · creators.kineticgain.com</div><div>Lane · Social / Creator Economy</div><div>Mode · Buyer-safe launch governance</div></div></div>`;
}
